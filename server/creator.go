...
func (r *creatorResolver) Comics(ctx context.Context, obj *maco.Creator, first *int, after *int) (*macogql.ComicsResult, error) {
	if len(obj.Comics) == 0 {
		return nil, nil
	}
...
func (r *creatorResolver) Events(ctx context.Context, obj *maco.Creator, first *int, after *int) (*macogql.EventsResult, error) {
	if len(obj.Events) == 0 {
		return nil, nil
	}
...
func (r *creatorResolver) Series(ctx context.Context, obj *maco.Creator, first *int, after *int) (*macogql.SeriesResult, error) {
	if len(obj.Series) == 0 {
		return nil, nil
	}
...
func (r *creatorResolver) Stories(ctx context.Context, obj *maco.Creator, first *int, after *int) (*macogql.StoriesResult, error) {
